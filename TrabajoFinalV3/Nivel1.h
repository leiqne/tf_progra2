...
namespace TrabajoFinalV3 {
	...
	public:
		Nivel1(void)
		{
			...
			bmpMap = gcnew Bitmap("Primer Nivel.png");
...
#pragma region Windows Form Designer generated code
		   ...
		   void InitializeComponent(void)
		   {
			   ...
			   this->pnlCanvas->Size = System::Drawing::Size(1011, 564);
			   this->pnlCanvas->TabIndex = 0;
			   this->pnlCanvas->MouseClick += gcnew System::Windows::Forms::MouseEventHandler(this, &Nivel1::pnlCanvas_MouseClick);
			   // 
			   // textBox3
			   // 
			   ...
			   this->textBox3->Location = System::Drawing::Point(0, 303);
			   ...
			   this->textBox2->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(0)),
				   static_cast<System::Int32>(static_cast<System::Byte>(64)));
			   this->textBox2->Location = System::Drawing::Point(3, 210);
			   ...
			   this->textBox2->TextChanged += gcnew System::EventHandler(this, &Nivel1::textBox2_TextChanged_1);
			   // 
			   // label2
			   // 
			   ...
			   this->label2->Location = System::Drawing::Point(667, 546);
			   ...
			   this->Pause2->Location = System::Drawing::Point(0, 303);
			   this->Pause2->Multiline = true;
			   this->Pause2->Name = L"Pause2";
			   this->Pause2->ReadOnly = true;
			   this->Pause2->Size = System::Drawing::Size(1008, 29);
			   ...
			   this->gameov2->TextChanged += gcnew System::EventHandler(this, &Nivel1::textBox2_TextChanged);
			   // 
			   // gamov
			   // 
			   ...
			   this->gamov->Location = System::Drawing::Point(219, 210);
			   this->gamov->Multiline = true;
			   this->gamov->Name = L"gamov";
			   this->gamov->ReadOnly = true;
			   this->gamov->Size = System::Drawing::Size(588, 66);
			   ...
			   this->progressBar1->Click += gcnew System::EventHandler(this, &Nivel1::progressBar1_Click);
			   // 
			   // timer_doctor
			   // 
			   this->timer_doctor->Enabled = true;
			   this->timer_doctor->Interval = 2500;
			   this->timer_doctor->Tick += gcnew System::EventHandler(this, &Nivel1::timer_doctor_Tick);
			   // 
			   // timer_virus
			   // 
			   this->timer_virus->Enabled = true;
			   this->timer_virus->Interval = 5000;
			   this->timer_virus->Tick += gcnew System::EventHandler(this, &Nivel1::timer_virus_Tick);
			   // 
			   // timer_v2
			   // 
			   this->timer_v2->Enabled = true;
			   this->timer_v2->Interval = 10000;
			   this->timer_v2->Tick += gcnew System::EventHandler(this, &Nivel1::timer_v2_Tick);
			   // 
			   // Nivel1
			   // 
			   this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			   this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			   this->ClientSize = System::Drawing::Size(1011, 564);
	...
	private: System::Void timer1_Tick(System::Object^ sender, System::EventArgs^ e) {
		...
		if (controller->getHeli() == true)
		{
			...
			if (Escribir.is_open())
			{
				...
				Escribir << Convert::ToInt32(controller->getDoctor()) << endl;
				Escribir << Convert::ToInt32(controller->getPuntos()) << endl;
			}
		...
		if (controller->getPuntos() - 5 <= 20)
		{
			progressBar1->Value = ((controller->getPuntos() - 5)*5);
		}
